...
from src.extract.contract import OverviewSchema
...
def extract_overview():
    ...
    for symbol in SYMBOLS:
        ...
        try:
            ...
            print(f"Validating overview data for {symbol}...")
            extraction_date = today.isoformat()

            validated_data = OverviewSchema.model_validate(files)
    ...
    log_destination = f"financial/metadata/overview/year={today.year}/month={today.month:02d}/day={today.day:02d}/overview_extraction.log"
