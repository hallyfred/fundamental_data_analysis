...
def extract_earning():
    ...
    for symbol in SYMBOLS:
        ...
        try:
            ...
            file_name = f"earning_{symbol}_{today}.json"
            ...
            print(f"Validating earning data for {symbol}...")
            ...
            destination_blob_name = f"financial/earning/year={today.year}/month={today.month:02d}/day={today.day:02d}/{file_name}"
            ...
            time_seconds = time.perf_counter() - start_time
            print(f"Error occurred while extracting earning data for {symbol}: {e}")
    ...
    log_destination = f"financial/metadata/earning/year={today.year}/month={today.month:02d}/day={today.day:02d}/earning_extraction.log"
