...
def extract_earning(symbols: list[str] | None = None):
    ...
    for symbol in symbols:
        ...
        try:
            ...
            if has_extra_fields(validated_data):
                ...
                quarantine_blob = (
                    f"financial/quarantine/earning/"
            ...
            fiscal_date = str(
                ...
                if validated_data.quarterlyEarnings
            ...
            destination_blob_name = (
                f"financial/earning/year={today.year}/month={today.month:02d}/day={today.day:02d}/{file_name}"
            )
    ...
    log_destination = (
        f"financial/metadata/earning/"
        f"year={today.year}/month={today.month:02d}/day={today.day:02d}/earning_extraction.log"
    )
