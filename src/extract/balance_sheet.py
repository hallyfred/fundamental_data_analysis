...
def extract_balance_sheet():
    ...
    for symbol in SYMBOLS:
        ...
        try:
            ...
            destination_blob_name = f"financial/balance_sheet/year={today.year}/month={today.month:02d}/day={today.day:02d}/{file_name}"
            ...
            time_seconds = time.perf_counter() - start_time
            print(f"Error occurred while extracting balance_sheet data for {symbol}: {e}")
    ...
    log_destination = f"financial/balance_sheet/metadata/year={today.year}/month={today.month:02d}/day={today.day:02d}/balance_sheet_extraction.log"
